...
SX1278Class::SX1278Class(int pin_ChipSelect, int pin_Reset, int pin_D0) :
_pin_CE(pin_ChipSelect),
_pin_RST(pin_Reset),
_pin_D0(pin_D0)
{
...
void SX1278Class::SX1278_SPIWrite(SX1278_t * module, uint8_t addr, uint8_t cmd) {
	SX1278_hw_SetNSS(module->hw, 0);
...
void SX1278Class::SX1278_SPIBurstRead(SX1278_t * module, uint8_t addr, uint8_t* rxBuf,
		uint8_t length) {
	uint8_t i;
	if (length <= 1) {
		return;
...
void SX1278Class::SX1278_SPIBurstWrite(SX1278_t * module, uint8_t addr, uint8_t* txBuf,
		uint8_t length) {
	unsigned char i;
	if (length <= 1) {
		return;
...
void SX1278Class::SX1278_defaultConfig(SX1278_t * module) {
...
void SX1278Class::SX1278_standby(SX1278_t * module) {
	SX1278_SPIWrite(module, LR_RegOpMode, 0x09);
	module->status = STANDBY;
}

void SX1278Class::SX1278_sleep(SX1278_t * module) {
	SX1278_SPIWrite(module, LR_RegOpMode, 0x08);
	module->status = SLEEP;
}

void SX1278Class::SX1278_entryLoRa(SX1278_t * module) {
	SX1278_SPIWrite(module, LR_RegOpMode, 0x88);
}

void SX1278Class::SX1278_clearLoRaIrq(SX1278_t * module) {
	SX1278_SPIWrite(module, LR_RegIrqFlags, 0xFF);
}

int SX1278Class::SX1278_LoRaEntryRx(SX1278_t * module, uint8_t length, uint32_t timeout) {
	uint8_t addr;
...
uint8_t SX1278Class::SX1278_LoRaRxPacket(SX1278_t * module) {
	unsigned char addr;
...
int SX1278Class::SX1278_LoRaEntryTx(SX1278_t * module, uint8_t length, uint32_t timeout) {
	uint8_t addr;
	uint8_t temp;
...
int SX1278Class::SX1278_LoRaTxPacket(SX1278_t * module, uint8_t* txBuffer, uint8_t length,
		uint32_t timeout) {
...
void SX1278Class::SX1278Class::SX1278_begin(SX1278_t * module, uint8_t frequency, uint8_t power,
...
int SX1278Class::SX1278_transmit(SX1278_t * module, uint8_t* txBuf, uint8_t length,
		uint32_t timeout) {
...
int SX1278Class::SX1278_receive(SX1278_t * module, uint8_t length, uint32_t timeout) {
	return SX1278_LoRaEntryRx(module, length, timeout);
}

uint8_t SX1278Class::SX1278_available(SX1278_t * module) {
	return SX1278_LoRaRxPacket(module);
}

uint8_t SX1278Class::SX1278_read(SX1278_t * module, uint8_t* rxBuf, uint8_t length) {
...
uint8_t SX1278Class::SX1278_RSSI_LoRa(SX1278_t * module) {
	uint32_t temp = 10;
...
uint8_t SX1278Class::SX1278_RSSI(SX1278_t * module) {
	uint8_t temp = 0xff;
